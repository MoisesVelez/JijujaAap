...
fun menuInitial(logingView: MvvmPresentation, navHostController: NavHostController){
    ...
    Scaffold(
        ...
        Column(
            Modifier.fillMaxSize().background(Brush.verticalGradient(listOf(White,colorEscogido))).padding(innerPadding)
...
fun navigationBar(
    ...
    NavigationBar(containerColor = White, modifier = Modifier.height(110.dp)){
        NavigationBarItem(selected = true,
            ...
            icon = {Icon(painter = painterResource(R.drawable.hogar),modifier= Modifier.size(20.dp), contentDescription = "")}
            ,label = { Text("Menu", fontWeight = FontWeight.Bold, color = Color.Black) })

        NavigationBarItem(selected = true,
            modifier = Modifier.padding(top = 40.dp),
            onClick = {},
            icon = {Icon(painter = painterResource(R.drawable.herramienta_lapiz),modifier= Modifier.size(20.dp), contentDescription = "")}
        ...
        NavigationBarItem(selected = true,
            ...
            icon = {Icon(painter = painterResource(R.drawable.amistad),modifier= Modifier.size(20.dp), contentDescription = "")}
